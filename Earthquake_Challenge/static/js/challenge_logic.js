...
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
  ...
  // This function returns the style color and weight for each of the tectonic plate lines we plot on the map. 
  function styleInfo(feature) {
    return {
      color: "OrangeRed",
      weight: 1.5
  ...
  L.geoJson(data, {
    ...
    // We set the style for each line using our styleInfo function.
    style: styleInfo,

    // We create a popup for each line to display the name of the tectonic plate
    onEachFeature: function(feature, layer) {
